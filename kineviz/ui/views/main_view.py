...
class MainView:
    ...
    def update_pagination_controls(self):
        ...
        # For this one, the long text is generated by _show_main_view_help, so we only set short_text for hover.
        # The `text` parameter of Tooltip is not directly used if command is separate.
